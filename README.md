...
├── image.png           # 项目截图1（暗色模式）
├── image-1.png         # 项目截图2（亮色模式）
├── static/
│   ├── css/            # 样式文件目录
│   ├── js/             # JavaScript 库
│   │   └── crypto-js.min.js
...
[![下载发行版](https://img.shields.io/badge/下载-发行版-blue)](https://github.com/Skyaura/ecupdate-linux/releases/latest)

或者直接下载：
- **Linux 版本**: [ecupdate-linux-v2.1.tar.gz](https://github.com/Skyaura/ecupdate-linux/releases/download/v2.1/ecupdate-linux-v2.1.tar.gz)
...
- **发行版下载**: [GitHub Releases](https://github.com/Skyaura/ecupdate-linux/releases)
